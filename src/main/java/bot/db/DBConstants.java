...
public class DBConstants {
    ...
    public static final String UPDATE_PLAYER_BY_PLAYER_ID_STMT = buildUpdateStatement("player", "player_id", "player_id", "player_name", "player_avatar", "player_bio", "player_rank", "player_country_rank", "player_pp", "player_country", "discord_user_id", "player_history", "user_customAccGridImage");
    public static final String DELETE_PLAYER_BY_DISCORD_ID = "delete from player where discord_user_id = ?;";
    public static final String INSERT_PLAYER_STMT = buildInsertStatement("player", "player_id", "player_name", "player_avatar", "player_bio", "player_rank", "player_country_rank", "player_pp", "player_country", "discord_user_id", "player_history");
    ...
    public static String buildUpdateStatement(String tableName, String whereValue, String... valuesToSet) {
        ...
        for (String s : valuesToSet) {
            params.append(s).append(" = ?,");
        }
        params = new StringBuilder(StringUtils.removeEnd(params.toString(), ","));
