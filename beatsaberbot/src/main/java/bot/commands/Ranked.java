...
public class Ranked {
	...
	public static void sendStarRangeRankedPlaylist(RankedMaps ranked, float min, float max, BeatSaver bs, MessageEventDTO event) {
	...
	public static void sendRecentRankedPlaylist(RankedMaps ranked, int recentAmount, BeatSaver bs, MessageEventDTO event) {
