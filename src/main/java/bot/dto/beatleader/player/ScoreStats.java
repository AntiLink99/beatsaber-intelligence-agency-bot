...
public class ScoreStats{
	...
	@SerializedName("authorizedReplayWatched")
	private int authorizedReplayWatched;

	@SerializedName("anonimusReplayWatched")
	private int anonimusReplayWatched;
	...
	@SerializedName("rankedMaxStreak")
	private int rankedMaxStreak;
	...
	public int getAuthorizedReplayWatched(){
		return authorizedReplayWatched;
	}

	public int getAnonimusReplayWatched(){
		return anonimusReplayWatched;
	}
	...
	public int getUnrankedMaxStreak(){
		return unrankedMaxStreak;
	}
	...
	public int getRankedMaxStreak(){
		return rankedMaxStreak;
	}
