...
public class BotConstants {
	...
	// Recent Songs
	public static final int songRectHeight = 250;
	public static final int songRectWidth = 1400;
	public static final int songRectYOffset = 25;
	...
	public static Map<String, String> getCommands() {
		...
		commands.put("ru recentsongs (optional: <@member>)", "Displays a player card for the recent scores set on ScoreSaber.");
		commands.put("ru topsongs (optional: <@member>)", "Displays a player card for the top scores set on ScoreSaber.");
